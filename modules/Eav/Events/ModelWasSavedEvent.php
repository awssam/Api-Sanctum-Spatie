...
class ModelWasSavedEvent
{
    ...
    public function saved(ObjectModel $entity): void
    {
    ...
    public function saving(ObjectModel $entity)
    {
        $this->removeEavAttributesFromModelBeforSaving($entity);
    }


    public function updating(ObjectModel $entity)
    {
    ...
    private function prepareTrashed(ObjectModel $entity)
    {
        $trash = [];
    ...
    private function removeEavAttributesFromModelBeforSaving(ObjectModel $entity)
    {
        foreach ($entity->trashedEav as $key => $value) {
